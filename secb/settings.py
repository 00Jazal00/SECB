"""
Django settings for secb project.
...
SECRET_KEY = 'django-insecure-2lt+nxivfn54f1^*eofx-dwv16&2=$sn*-lg@p9k@maqc301v%'
...
WSGI_APPLICATION = 'secb.wsgi.application'
